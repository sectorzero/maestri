...
// Unit Test Class
class TestHelloTwo : public CppUnit::TestCase
{
    public:
        // --------------------------------------------------------------------
        // TestCase : SampleCase
        // --------------------------------------------------------------------
        void testSampleCase(void)
        { 
            HelloTwo a;
    ...
    public:
        CPPUNIT_TEST_SUITE(TestHelloTwo);
        // >>
        CPPUNIT_TEST(testSampleCase);
        // <<
...
CPPUNIT_TEST_SUITE_REGISTRATION(TestHelloTwo);
